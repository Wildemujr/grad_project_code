...
read -p $'\nWhat will the residue offset be?\n> ' res_offset
...
trajin ${coord_wa}
reference ${na}.wa.pdb
nativecontacts name NC1 :1-${resi} byresidue resoffset ${res_offset} out nc.all.res.dat mindist maxdist distance 3.0 reference map mapout ${na}.resmap.gnu contactpdb ${na}.native.contacts.pdb series seriesout native.dat
run
eof
